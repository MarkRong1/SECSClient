...
namespace SECSClient.Equipment.Modbus
{

    public class ModbusController : BackgroundService, INotificationHandler<MRPublishMessage>, IModbusController
    {
        private readonly IMediator _mediator;
        private readonly LogBuffer _buffer;
        private readonly string _logFolder = "Modbus";
        public ModbusController(IMediator mediator, LogBuffer buffer)
        {
            _mediator = mediator;
            _buffer = buffer;
        }
        ...
        {
            if (!string.Equals(req.Receiver, "MODBUS", StringComparison.OrdinalIgnoreCase))
                return false;
