...
public class PLCController_Mitsubishi : BackgroundService, INotificationHandler<MRPublishMessage>, IPLCController
{
    private readonly IMediator _mediator;
    private readonly LogBuffer _buffer;
    private readonly string _logFolder = "PLC";
    public PLCController_Mitsubishi(IMediator mediator, LogBuffer buffer)
    {
        _mediator = mediator;
        _buffer = buffer;
    }
